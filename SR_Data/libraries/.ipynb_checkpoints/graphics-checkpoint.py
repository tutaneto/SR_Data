...
def add_annot(annotations, x, y, txt, color, size, xanchor='left', yanchor='middle', align='center', bg_color=False):
...
def draw_line(fig, x0, y0, x1, y1, color, width=1, opacity=1.0, dash='solid', layer=None):
    if layer == None:
        layer = 'below'
