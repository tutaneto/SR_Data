...
FONT_BHDTITLE = 'Montserrat-Black'
FONT_ABVGRAPH_TXT = 'Montserrat-Regular'
FONT_ABVGRAPH_VALUE = 'Montserrat-Black'
FONT_SUBGRAPH_TXT = 'Montserrat-Thin'
FONT_SUBGRAPH_VALUE = 'Montserrat-Bold'
FONT_ONGRAPH_TXT = 'Montserrat-MediumItalic'
FONT_ONGRAPH_VALUE = 'Montserrat-BoldItalic'
FONT_XAXIS = 'Arial-Bold'
...
T_COLOR_2 = '#6BAEFF'  # behind title 
T_COLOR_3 = '#0A2038'  # date text
T_COLOR_4 = '#8FB5D1'  # above graph text
T_COLOR_5 = '#ABB2BA'  # bellow graph text
T_COLOR_6 = '#FF657F'  # negative color
T_COLOR_7 = '#65E0FF'  # positive color 
T_COLOR_8 = '#263240'  # graph background 

BG_COLOR = '#263240'

BLOCK_BG_COLOR_MID_UP = '#FFFFFF'
BLOCK_BG_COLOR_MID_DN = '#FFFFFF'  # new
BLOCK_BG_COLOR_END_UP = '#FFFFFF'  # T_COLOR_4  # new
BLOCK_BG_COLOR_END_DN = '#FFFFFF'  # T_COLOR_1  # new

BLOCK_V3_COLOR = T_COLOR_1

BLOCK_COLORS = [BLOCK_BG_COLOR_MID_UP,
        BLOCK_BG_COLOR_MID_UP, BLOCK_V3_COLOR, T_COLOR_3]
LEGEND_COLORS = BLOCK_COLORS

XAXIS_TEXT_COLOR = '#000000'
YAXIS_TEXT_COLOR = None
YAXIS_LINE_COLOR = None
YAXIS_LINE_OPACITY = None

TITLE_COLOR  = '#FFFFFF'  # T_COLOR_1
SUBTIT_COLOR = '#CCFFFF'  # T_COLOR_7
DFONT_COLOR  = '#CCFFFF'  # T_COLOR_7
