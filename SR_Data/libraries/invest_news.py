...
# whatsapp_groups = [['Ajustes SR data', 'Ex & Gênius & Bét']]
...
#           COLORS
#######################################
T_COLOR_1 = '#393939'  # Very Dark Gray
...
MAIN_LOGO_PNG = 'images/invest_news/INS_BR.png'  # Investnews_CZ


#######################################
#           WATERMARK
#######################################
WATERMARK_IMG = 'images/invest_news/INS_black.png'
...
FLAG_CIRCLE_COLOR_UP = '#2099C9'
FLAG_CIRCLE_COLOR_DN = '#9C1A7F'
...
# graphtime
GT_MARGINS_LRTBPAD = 180, 120, 200, 170, 10
GT_LEGEND_X = 1.02
GT_LEGEND_Y = 1
GT_LEGEND_FS = 18
