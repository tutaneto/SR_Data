...
BLOCK_BG_COLOR_MID_UP = 'gradient_blue_up.png'  # untill last bar in positive side
BLOCK_BG_COLOR_MID_DN = 'gradient_blue_down.png'  # untill last bar in negative side
BLOCK_BG_COLOR_END_UP = BLOCK_BG_COLOR_MID_UP  # last bar in positive side
BLOCK_BG_COLOR_END_DN = BLOCK_BG_COLOR_MID_DN  # last bar in negative side

BLOCK_V3_COLOR = '#FFFFFF'
...
TITLE_COLOR  = '#38424D'
SUBTIT_COLOR = '#475667'  # T_COLOR_1
DFONT_COLOR  = '#38424D'  # T_COLOR_1
...
BLOCK_X = TITLE_X
BLOCK_Y = TITLE_Y + 900  # 540
BLOCK_W = 50    # 50
BLOCK_H = 600
BLOCK_DX = 80  # 80
BLOCK_DX_FACTOR = 1.6

DFONT_X = TITLE_X + 1350
DFONT_Y = SUBTIT_Y + 10

BAR_VAL_FONT_SIZE  = 36  #  36 # 30  # 25 + 1
...
FOCUS_TIT_COLOR = T_COLOR_5
FOCUS_TIT_FONT_SIZE = 53

FOCUS_TYPE_COLOR = T_COLOR_5
FOCUS_TYPE_FONT_SIZE = 24

FOCUS_FOOT_COLOR = T_COLOR_7
...
FOCUS2_BLK_Y, FOCUS2_BLK_Y2 = 375, 425
FOCUS2_BLK_W, FOCUS2_BLK_W2 = 1550, 1190
FOCUS2_BLK_H = 80
# FOCUS2_BLK_DX = FOCUS2_BLK_W + 8
FOCUS2_BLK_DY = FOCUS2_BLK_H + 8

FOCUS2_BLK_IN_DX = 300
FOCUS2_BLK_IN_DY = 0
...
FOCUS2_TIT_COLOR = T_COLOR_5
FOCUS2_TIT_FONT_SIZE = 48

FOCUS2_TYPE_COLOR = T_COLOR_5
